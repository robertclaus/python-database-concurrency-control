query_sets = [
              ...
              [
               "SELECT a.a1,a.a2 FROM t.a WHERE a.a1 = <randIntO7>;", 20,
               "UPDATE t.a SET a.a2 = <randIntO7> WHERE a.a2 = <randIntO7>;", 80,
               ],
              [
               "UPDATE t.a SET a.a2 = <randIntO7> WHERE a.a2 = <randIntO7>;", 100,
               ],
              [
               "SELECT a.a1,a.a2 FROM t.a WHERE a.a1 = <randIntO7>;", 100,
               ],
              ...
              [
               ...
               FROM subscriber \
               WHERE subscriber.s_id = <non_uniform_rand_int_subscriber_size>; ",0, # was 35
               ...
               AND call_forwarding.end_time >= <rand_1_to_24>);",0, # was 10
               ...
               AND access_info.ai_type = <rand_int_1_4>;",0, # was 35
               ...
               WHERE subscriber.sub_nbr = '<non_uniform_rand_int_subscriber_size_string>';",100, # Was 14
               ...
               ORDER BY RAND() LIMIT 1;",0, # Was 2, but self-conflicting was an issue.
